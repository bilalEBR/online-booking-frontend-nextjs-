            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input type="date" min={today} className={`w-full p-3.5 bg-gray-50 border rounded-2xl outline-none focus:bg-white focus:ring-2 focus:ring-blue-900 ${fieldErrors.checkInDate ? 'border-red-300' : 'border-gray-100'}`} value={formData.checkInDate} onChange={e => setFormData({...formData, checkInDate: e.target.value})} />
                ...
                <div>
                  ...
                  <input type="date" min={formData.checkInDate || today} className={`w-full p-3.5 bg-gray-50 border rounded-2xl outline-none focus:bg-white focus:ring-2 focus:ring-blue-900 ${fieldErrors.checkOutDate ? 'border-red-300' : 'border-gray-100'}`} value={formData.checkOutDate} onChange={e => setFormData({...formData, checkOutDate: e.target.value})} />
