...
// 2. Add a submittng state to prevent double-clicking the submit button
const [isSubmitting, setIsSubmitting] = useState(false);
  ...
  if (isVerifying || !room) return <div className="h-screen flex items-center justify-center font-bold text-blue-900 animate-pulse">Verifying room data...</div>;
    ...
    <div className="w-full md:w-5/12 bg-blue-950 text-white p-8 flex flex-col justify-between">
      <div className="space-y-6">
        ...
        <div className="bg-white/5 p-6 rounded-2xl border border-white/10">
          ...
          <div className="flex justify-between mb-2">
            ...
            <span className="font-medium">{room.pricePerNight} ETB</span>
          </div>
        ...
        {/* Updated Bank Detail Section */}
        <div className="mt-8">
          <p className="text-[10px] uppercase text-blue-400 mb-2 font-bold tracking-widest">Official Bank Account</p>
          <div className="bg-white/5 p-5 rounded-2xl border border-white/10 space-y-3">
            <div className="flex flex-col">
              <span className="text-[10px] uppercase text-gray-500 font-bold">Bank Name</span>
              <span className="text-sm font-medium text-gray-200">Commercial Bank of Ethiopia</span>
            </div>
            <div className="flex flex-col">
              <span className="text-[10px] uppercase text-gray-500 font-bold">Account Holder</span>
              <span className="text-sm font-medium text-gray-200">Grand Semen Hotel</span>
            </div>
            <div className="flex flex-col">
              <span className="text-[10px] uppercase text-gray-500 font-bold">Account Number</span>
              <span className="text-lg font-mono font-bold text-blue-400 tracking-wider">1000473523117</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="mt-8">
        ...
        <div className="aspect-video bg-black/40 rounded-2xl border-2 border-dashed border-white/20 overflow-hidden flex items-center justify-center">
          {previewUrl ? (
            <img src={previewUrl} className="w-full h-full object-cover" alt="Receipt preview" />
          ) : (
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div>
          ...
          <div className="relative">
            ...
            <input
              type="text"
              className={`w-full pl-12 pr-4 py-3.5 bg-gray-50 border rounded-2xl outline-none focus:bg-white focus:ring-2 focus:ring-blue-900 transition-all ${fieldErrors.senderName ? 'border-red-300 bg-red-50' : 'border-gray-100'}`}
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <input
              type="date"
              min={today}
              className={`w-full p-3.5 bg-gray-50 border rounded-2xl outline-none focus:bg-white focus:ring-2 focus:ring-blue-900 ${fieldErrors.checkInDate ? 'border-red-300' : 'border-gray-100'}`}
          ...
          <div>
            ...
            <input
              ...
              className={`w-full p-3.5 bg-gray-50 border rounded-2xl outline-none focus:bg-white focus:ring-2 focus:ring-blue-900 ${fieldErrors.checkOutDate ? 'border-red-300' : 'border-gray-100'}`}
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              type="text"
              className={`w-full pl-12 pr-4 py-3.5 bg-gray-50 border rounded-2xl outline-none focus:bg-white focus:ring-2 focus:ring-blue-900 ${fieldErrors.transactionNum ? 'border-red-300 bg-red-50' : 'border-gray-100'}`}
              placeholder="TXN-XXXX-XXXX"
              value={formData.transactionNum}
        ...
        <button
          ...
          className={`w-full py-5 rounded-2xl font-black text-sm transition-all flex items-center justify-center gap-2 ${
            isSubmitting ? "bg-gray-400 cursor-not-allowed" : "bg-blue-900 text-white hover:bg-blue-800"
          }`}
        >
...
// --- 2. THE EXPORT COMPONENT (Wraps the content in Suspense) ---
export default function NewBookingPage() {
  return (
    <Suspense fallback={<div className="h-screen flex items-center justify-center bg-gray-50 font-bold text-blue-900">Loading secure reservation desk...</div>}>
      <BookingFormContent />
    </Suspense>
  );
}