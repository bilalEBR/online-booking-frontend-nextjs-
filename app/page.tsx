    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-blue-900 text-white py-16 px-4">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-blue-100 text-lg opacity-90">Luxury rooms starting from 300 ETB</p>
        </div>
      </header>
...
{showAuthModal && (
  <div className="fixed inset-0 bg-black/60 backdrop-blur-md z-[100] flex items-center justify-center p-4">
    <div className="bg-white rounded-[32px] w-full max-w-sm p-8 shadow-2xl border border-gray-100 animate-in zoom-in duration-200">
      ...
      <div className="flex flex-col items-center text-center">
        ...
        <h2 className="text-2xl font-black text-gray-900 tracking-tight mb-2">Login Required</h2>
        <p className="text-gray-500 text-sm leading-relaxed mb-8">
          To finalize your reservation and secure this room, you need to be logged into your account.
        </p>
      </div>
      ...
      <p className="text-center mt-6 text-xs text-gray-400 font-medium">
        ...
        <button onClick={() => router.push("/login")} className="text-blue-900 font-black ml-1 hover:underline">
          Sign In
        </button>
      </p>
    </div>
  ...
  {/* DARK OVERLAY (Optional - helps the badge pop) */}
                ...
                <div className="p-6 flex-1 flex flex-col">
                  <div className="flex justify-between items-start mb-2">
                    ...
                    {/* <div className="text-right">
                      <p className="text-xl font-bold text-blue-900">{room.pricePerNight} ETB</p>
